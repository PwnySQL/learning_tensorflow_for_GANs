"""
    ...
    It measures the "precision @ 1", which indicates, how often the top
    prediction matches the true label of the image.
...
def eval_once(saver, summary_writer, top_k_op, summary_op):
    ...
    with tf.Session() as sess:
        ...
        if ckpt and ckpt.model_checkpoint_path:
            ...
            # assume model_checkpoint_path looking like:
        ...
        try:
            ...
            true_count = 0  # counting correct predictions
